...
import cn.konat4.blog.dao.BlogConfigMapper;
import cn.konat4.blog.entity.BlogConfig;
import cn.konat4.blog.service.ConfigService;
...
public class ConfigServiceImpl implements ConfigService {
    ...
    public static final String websiteDescription = "Personal Blog";
    ...
    public static final String yourAvatar = "/admin/dist/img/konat4_1.jpg";
    public static final String yourEmail = "805157984@qq.com";
    public static final String yourName = "Konat4";

    public static final String footerAbout = "Have Fun.";
    public static final String footerICP = "互联网 ICP 备案: 赣 ICP 备 xxxxxxxx 号 - x";
    public static final String footerCopyRight = "@2021 Konat4";
